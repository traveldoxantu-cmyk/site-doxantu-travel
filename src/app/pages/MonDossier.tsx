...
export function MonDossier() {
    const steps = [
        {
            id: 1,
            title: 'Étape 1 — Soumission du dossier',
        ...
        {
            id: 2,
            title: 'Étape 2 — Vérification des documents',
        ...
        {
            id: 3,
            title: 'Étape 3 — Entretien pédagogique',
            date: '7 mars 2026',
            status: 'current',
            icon: GraduationCap,
            content: (
                <div className="mt-6 pt-6 border-t border-gray-100">
                    <p className="text-gray-600 mb-4 leading-relaxed">
                        Rendez-vous Campus France confirmé. Préparez votre projet d'études et votre motivation pour étudier en France. L'entretien dure environ 30 minutes.
                    </p>
                    <ul className="space-y-3 mb-6">
                        <li className="flex items-center gap-2 text-sm text-[#333333] font-medium">
                            <Calendar className="w-4 h-4 text-gray-400" /> Date : 7 mars 2026 à 10h00
                        </li>
                        <li className="flex items-center gap-2 text-sm text-[#333333] font-medium">
                            <MapPin className="w-4 h-4 text-gray-400" /> Lieu : Campus France Dakar – Rue Carnot
                        </li>
                        <li className="flex items-center gap-2 text-sm text-[#333333] font-medium">
        ...
        {
            id: 4,
            title: 'Étape 4 — Demande de visa',
            date: 'Prévu avril 2026',
            status: 'upcoming',
            icon: FileText
        },
        {
            id: 5,
            title: 'Étape 5 — Confirmation d\'admission',
            date: 'Prévu mai 2026',
            status: 'upcoming',
            icon: Building2
        },
        ...
        <div className="max-w-4xl mx-auto pb-24 relative min-h-full space-y-8">
            ...
            <div className="flex justify-between items-start mb-2">
                ...
                <div className="text-right">
                    <p className="text-3xl font-black text-[#1a2b40]">33%</p>
            ...
            <div className="mb-8">
                <div className="flex justify-between items-center text-xs text-gray-400 font-medium mb-3">
                    ...
                    <span>2/6 étapes</span>
                </div>
                <div className="relative">
                    <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                        <div className="h-full bg-[#0B84D8] rounded-full transition-all duration-1000" style={{ width: '33%' }}></div>
                    </div>
                    {/* Dots */}
                    <div className="relative flex justify-between">
                        {[1, 2, 3, 4, 5, 6].map((step) => (
                            <div key={step} className={`w-3 h-3 rounded-full border-2 ${step <= 2 ? 'bg-[#0B84D8] border-[#0B84D8]' : step === 3 ? 'bg-white border-[#0B84D8]' : 'bg-gray-100 border-gray-100'}`}></div>
                        ))}
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#F0F8FF] border border-[#0B84D8]/20 rounded-2xl p-6 flex gap-4">
                ...
                <div>
                    ...
                    <p className="text-[#333333]">
                        Votre <span className="font-bold">entretien Campus France</span> est prévu le <span className="font-bold">7 mars 2026</span>. Préparez votre projet d'études et apportez tous vos documents originaux.
                    </p>
                </div>
            </div>
