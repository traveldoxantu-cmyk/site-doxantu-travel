        ...
        <div className="max-w-2xl mx-auto">
          {user?.role === 'admin' ? (
            <AdminRestrictionNotice 
              title="Évaluation de Projet & Devis"
              description="Les administrateurs ne peuvent pas créer de nouvelles demandes de devis. Veuillez utiliser le Dashboard pour gérer les dossiers clients."
            />
          ) : (
            <>
              {/* Progress steps */}
